...
$(document).ready(function() {
    ...
    // $('#book-welcome').css('background-color', "cyan" );
    ...
    // $('#container').css({'background-color': 'cyan', 'color': 'black'});
    ...
    $('#mystery-genre, #book-bundle-three').css('background-color', '#dc6532');
