$(document).ready(function() {
    ...
    // console.log($.ajax("https://hookb.in/qBVa7rnGlWUR1nBgPMZm?username=Bob"));
    ...
    // };
    //
    // console.log($.ajax("https://hookb.in/qBVa7rnGlWUR1nBgPMZm", person));
    ...
    // };
    //
    // console.log($.ajax("https://hookb.in/qBVa7rnGlWUR1nBgPMZm", bob));
     ...
     */
    //
    // var newMovie = $.ajax("https://swapi.co/api/films", {
    //     type: "GET",
    //     data: {
     ...
     */
    //
    // var newMovie = $.get("https://swapi.co/api/films", {
    //         "search": "The Force Awakens"
    // });
    //
    // newMovie.done(function (data) {
    ...
    //     console.log(data);
    //
    //     //iterates over books.json (array of objects)
    ...
    function generateBooks (){
        ...
        requestBooks.done(function (data) {
            ...
            $.each(data, function (index, book) {
                ...
                //log each book title
                console.log(book.title);
                //appends content into the div with id of main
                $('#main').append(content);
            });
        });
    ...
    //call the function to generate on page load
    generateBooks();
    /*
    ...
    //create event listener on refresh button
